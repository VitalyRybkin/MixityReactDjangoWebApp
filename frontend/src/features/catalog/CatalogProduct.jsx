...
export default function CatalogProduct() {
    ...
    const handleAdd = () => {
        ...
        const path = isSale ? '/catalog/sales-prices/create' : '/catalog/purchase-prices/create'

        const ownerParam = isSale ? `customer=${selection.entity.id}` : `warehouse=${selection.entity.id}`

        navigate(`${path}?product=${product.id}&${ownerParam}`, {
            state: {
